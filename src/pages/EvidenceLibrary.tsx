...
import { ArrowLeft, Microscope, Search, Loader2, Plus, Trash2, ExternalLink, BookMarked } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-24 md:pb-0">
      ...
      <div>
        <p className="text-primary text-xs tracking-[0.3em] uppercase mb-2 flex items-center gap-2">
          <Microscope className="h-3.5 w-3.5" /> Biblioteca de evidências
        </p>
        <h1 className="font-serif text-4xl mb-2">Só cita o que é real</h1>
        <p className="text-muted-foreground">
          Busque artigos reais no PubMed e curadore os que confia. A IA só cita estudos desta
