...
let _settings: DoctorSettings = { webhooks: {}, preferredFormats: ['caption', 'carousel', 'reel', 'linkedin'], schedulingLink: null, whatsappWebhookUrl: null };
let _hydrated = false;
let _channels: any[] = [];
...
export function resetStore() {
  ...
  _brain = EMPTY_BRAIN;
  _jobs = [];
  _settings = { webhooks: {}, preferredFormats: ['caption', 'carousel', 'reel', 'linkedin'], schedulingLink: null, whatsappWebhookUrl: null };
  _hydrated = false;
